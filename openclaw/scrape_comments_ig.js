...
const { scrapeComments, parseArgs, pollCount, sleep } = require('./comment_engine');
...
if (!url) { console.log('Usage: node scrape_comments_ig.js <post_or_reel_url> [out.json] [--max N]'); process.exit(1); }
