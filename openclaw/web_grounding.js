...
async function groundTerms(terms, { max = 5, client } = {}) {
  const out = {};
...
module.exports = { groundTerms, googleNewsHeadlines };

// ---- CLI (debug) ----
if (require.main === module) {
  const terms = process.argv.slice(2);
  if (!terms.length) { console.log('Usage: node web_grounding.js "<term>" ["<term2>" ...]'); process.exit(1); }
