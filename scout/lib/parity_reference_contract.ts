...
/**
 * Covers isolated-browser readiness, seed inspection, the summary, attempt
 * finalization, and normal two-child teardown around that stage.
 */
export const SOURCE_REFERENCE_OVERHEAD_RESERVE_MS = 5 * 60_000;

/** The supervisor's hard outer boundary: the retained stage plus its reserve. */
