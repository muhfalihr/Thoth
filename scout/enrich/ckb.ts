...
async function pgClient() {
  ...
  let Client; try { ({ Client } = (await import('pg')).default); } catch (e) { return null; } // pg (CJS) not installed → local fallback
...
export { load, save, get, put, norm, bumpPulse, prunePulse, topPulse, setRegister, getRegister, supabaseUrl, LOCAL_PATH };
